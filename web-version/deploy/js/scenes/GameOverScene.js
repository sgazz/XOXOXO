class GameOverScene extends Phaser.Scene {
    ...
    createGameOverContent() {
        ...
        this.container.fillStyle(0x1a1a2e, 0.95);
        ...
        this.container.lineStyle(3, COLORS.PRIMARY_GOLD);
        ...
        // Game over title
        this.title = this.add.text(containerX, containerY - 120, 'KRAJ IGRE', {
            fontFamily: 'Inter',
            fontSize: '2.5rem',
            fontWeight: '800',
        ...
        if (this.results.reason === 'timeout') {
            resultMessage = `Vreme je isteklo za igrača ${this.results.timeoutPlayer}!`;
            resultColor = COLORS.RED;
        } else if (this.results.reason === 'victory') {
            resultMessage = `Pobednik: ${this.results.winner}!`;
    ...
    createActionButtons() {
        ...
        const buttons = [
            { text: 'Nova igra', action: () => this.startNewGame() },
            { text: 'Glavni meni', action: () => this.returnToMenu() },
